...
//             <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-blue-500/30 transition-all duration-300">
...
//                     <p className="text-gray-300">Sr. No 36/1/3, 5th Floor Audumbar Nivya<br />
// Near Canara Bank, Narhe gaon , Pune - 411041</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                     key={social}
//                     href="#"
//                     className="w-12 h-12 bg-white/10 hover:bg-blue-500 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110"
//                   >
...
//                     onChange={handleChange}
//                     className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300"
//                   >
...
const ContactForm = () => {
  ...
  useEffect(() => {
    const syncHeights = () => {
      if (contactInfoRef.current && contactFormRef.current) {
        const contactInfoHeight = contactInfoRef.current.offsetHeight;
        const contactFormHeight = contactFormRef.current.offsetHeight;
        
        // Set both to the maximum height
        const maxHeight = Math.max(contactInfoHeight, contactFormHeight);
        contactInfoRef.current.style.minHeight = `${maxHeight}px`;
        contactFormRef.current.style.minHeight = `${maxHeight}px`;
      }
    };

    // Sync heights on initial render and window resize
    syncHeights();
    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div 
            ref={contactFormRef}
            className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 transition-all duration-300"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
        ...
        <div className="mt-12 rounded-2xl overflow-hidden border border-white/10">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.84787393056!2d73.8204363793457!3d18.445215000000008!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2956c2b39f1d3%3A0xa0b060f750ca2237!2sSynture%20Solutions%20Private%20Limited!5e0!3m2!1sen!2sin!4v1763376963230!5m2!1sen!2sin" 
            width="100%" 
            height="300" 
            style={{ border: 0 }} 
            allowFullScreen="" 
            ...
            title="Synture Solutions Location"
          ></iframe>
        </div>
      </div>
    </section>
